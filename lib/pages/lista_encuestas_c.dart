...
class ListaEncuestasC extends StatefulWidget {
  @override
  _ListaEncuestasCState createState() => _ListaEncuestasCState();
}

class _ListaEncuestasCState extends State<ListaEncuestasC> {
  ...
  Future<void> _loadStateAndEncuestas() async {
    ...
    userName = await OfflineStateManager.getUserName() ?? 'Usuario Bloque';
