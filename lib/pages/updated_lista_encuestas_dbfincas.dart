...
class ListaEncuestasFinca extends StatefulWidget {
  @override
  _ListaEncuestasFincaState createState() => _ListaEncuestasFincaState();
}

class _ListaEncuestasFincaState extends State<ListaEncuestasFinca> {
